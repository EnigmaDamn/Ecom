    ...
    return (
      <Container>
        <Left>
          <Logo>The Store.</Logo>
          <Desc>
          Welcome to The Store, your shopping destination for fashion online.
        ...
        <Center>
          ...
          <List>
            ...
            <ListItem>Home Products</ListItem>
        ...
        <Right>
          ...
          <ContactItem>
            <Phone style={{marginRight:"10px"}}/> +1 3462355523
          </ContactItem>
          <ContactItem>
            <MailOutline style={{marginRight:"10px"}} /> contact@thestore.dev
          </ContactItem>
